    ...
    boards: [
        {
            ...
            date     : "01/01/2001",
            title    : "Mon parcours",
            text     : "J'ai obtenu mon baccalauréat STI2D qui est une filière technologique axée sur les sciences et technologies de l'industrie et du développement \ndurable. J'ai ensuite poursuivi avec un DUT informatique, cette formation est axée sur la programmation, les bases de données, les réseaux \ninformatiques, ainsi que sur la conception et le développement de logiciels.Puis j'ai continué avec une licence 3 MIASHS, cette formation m'a \npermis d'acquérir des compétences en modélisation et analyse de données, ainsi que des connaissances en sciences sociales. Enfin, je suis \nactuellement en master ICE-LD, spécialisé dans l'ingénierie des connaissances et la gestion de données."
        },
        {
            start_pos: {x:0 , y:0 ,z:0, r:0},
